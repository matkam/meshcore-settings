...
const built = {
  // First key, so it is the first line anyone opening this file reads. The
  // string is static: printJson's output has to stay a pure function of the
  // content, so a rebuild with no edits produces no diff.
  notice: "Generated by scripts/build-regions.mjs from data/regions.yaml — " +
    "do not edit by hand. Edit the YAML and run: npm run build:regions",
  format: data.format,
  name: data.name,
